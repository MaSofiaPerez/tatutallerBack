 ...
 * Estas pruebas verifican el comportamiento end-to-end del sistema de autenticación
 */
@SpringBootTest
@AutoConfigureWebMvc
@ActiveProfiles("test")
...
class AuthIntegrationTest {
    ...
    void flujoCompleto_RegistroYLogin_DeberiaFuncionar() throws Exception {
        // Arrange
        RegisterRequest registerRequest = new RegisterRequest("Integration User", "integration@test.com", "password123");
    ...
    void registroDuplicado_DeberiaFallar() throws Exception {
        // Arrange
        RegisterRequest registerRequest = new RegisterRequest("Duplicate User", "duplicate@test.com", "password123");
    ...
    @Transactional
    void flujoCompleto_ConDiferentesTiposUsuarios(String nombre, String email, String password, String descripcion) throws Exception {
        // Arrange
    ...
    static Stream<Arguments> usuariosParaPruebas() {
        return Stream.of(
                Arguments.of("Juan Pérez", "juan.perez@test.com", "password123", "Usuario con nombre normal"),
                Arguments.of("María José García-López", "maria.garcia@test.com", "securePass456", "Usuario con nombre compuesto"),
                Arguments.of("O'Connor Smith", "oconnor@test.com", "mypassword789", "Usuario con apostrofe"),
                Arguments.of("李小明", "li.xiaoming@test.com", "chineseuser123", "Usuario con caracteres chinos"),
                Arguments.of("Admin", "admin.integration@test.com", "adminPass123", "Usuario administrador"),
                Arguments.of("Test Teacher", "teacher.test@test.com", "teacherPass456", "Usuario profesor")
        );
    }
    ...
    void datosUsuario_DebenPersistirCorrectamente() throws Exception {
        // Arrange
        RegisterRequest registerRequest = new RegisterRequest("Persistence Test", "persistence@test.com", "password123");
    ...
    void loginConPasswordIncorrecta_DeberiaFallar() throws Exception {
        ...
        RegisterRequest registerRequest = new RegisterRequest("Wrong Pass User", "wrongpass@test.com", "correctpassword");
    ...
    void validacionRegistro_CasosLimite(RegisterRequest request, boolean deberiaSerValido, String descripcion) throws Exception {
        if (deberiaSerValido) {
            mockMvc.perform(post("/api/auth/register")
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    static Stream<Arguments> casosLimiteRegistro() {
        return Stream.of(
                ...
                Arguments.of(new RegisterRequest("A", "a@b.co", "123456"), true, "Nombre de 1 caracter"),
                Arguments.of(new RegisterRequest("A".repeat(100), "long@test.com", "123456"), true, "Nombre de 100 caracteres"),
                Arguments.of(new RegisterRequest("Test", "test@test.com", "123456"), true, "Password de 6 caracteres exacto"),
                
                // Casos inválidos límite
                Arguments.of(new RegisterRequest("A".repeat(101), "toolong@test.com", "123456"), false, "Nombre de 101 caracteres"),
                Arguments.of(new RegisterRequest("Test", "test@test.com", "12345"), false, "Password de 5 caracteres")
        );
    }
}
